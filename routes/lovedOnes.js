...
function setupLovedOnesRoutes(router, dependencies) {
  ...
  router.get('/loved-ones/all', authMiddleware, (req, res) => {
    lovedOneController.getAllLovedOnes(req, res, driver, auditLogger, neo4jDatabase);
  });
  ...
  router.get('/loved-ones/with-coordinates', authMiddleware, (req, res) => {
    lovedOneController.getLovedOnesWithCoordinates(req, res, driver, auditLogger, neo4jDatabase);
  });
  ...
  router.get('/loved-ones/by-date', authMiddleware, (req, res) => {
    lovedOneController.getLovedOnesByDate(req, res, driver, auditLogger, neo4jDatabase);
  });
  ...
  router.get('/loved-ones/by-province', authMiddleware, (req, res) => {
    lovedOneController.getLovedOnesByProvince(req, res, driver, auditLogger, neo4jDatabase);
  });
  ...
  router.get('/loved-ones', authMiddleware, (req, res) => {
    lovedOneController.getLovedOnesByCommunity(req, res, driver, auditLogger, neo4jDatabase);
  });

  // PUT /api/loved-ones/:id - Update loved one (admin or assigned case_worker)
  router.put('/loved-ones/:id', authMiddleware, (req, res) => {
    lovedOneController.updateLovedOne(req, res, driver, auditLogger, neo4jDatabase);
  });
}
