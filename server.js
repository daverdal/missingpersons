...
const setupReminderRoutes = require('./routes/reminders');
...
setupReminderRoutes(reminderRouter, {
  driver,
  auditLogger,
  authMiddleware,
  requireRole
...
setupDashboardRoutes(dashboardRouter, {
  driver,
  auditLogger,
  authMiddleware,
  requireRole
...
setupWitnessRoutes(witnessRouter, {
  driver,
  auditLogger,
  authMiddleware,
  requireRole
...
setupCalendarRoutes(calendarRouter, {
  driver,
  auditLogger,
  authMiddleware,
  requireRole
